...
def generate_output_files_diffent(different_xml_path,different_string_path,rate,replace_output_path):
...
if __name__ == '__main__':
    ...
    generate_output_files_diffent(different_xml_path, different_string_path, rate, replace_output_path)
